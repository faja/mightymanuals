...
local varQueue = grafana.template.custom(
  'queue',          // name
'generate_vacancies_under_watch_report,generate_single_vacancies_under_watch_report,generate_all_vacancy_reports,generate_vacancy_reports_from_elasticsearch,generate_elasticsearch_overall_vacancy_chunk_reports,generate_elasticsearch_monthly_vacancy_chunk_reports,cache_career_site_stats,produce_roi_reports,regenerate_roi_reports,produce_single_roi_report,check_session,check_event_broken_session_uuid,create_price_tags_adjustments,create_templates_price_tags_adjustments,export_tracking_pixels_to_tracker,log_webhook_payload', // query
  'All',            // current
  includeAll=true,
  multi=true,
);
