...
local varQueue = grafana.template.custom(
  'queue',        // name
  'charge_click,charge_job_application,log_custom_event,log_impression,log_job_view,log_page_view,handle_event_updatelabels,handle_event_createlabels,handle_event_deletelabels,log_metrics,log_single_metric,log_candidate,celery,haystack,ban_cross_device_id,handle_webhooks,export_vacancies_to_tracker,export_vacancies_to_elasticsearch,export_vacancies_chunk_to_elasticsearch,remove_vacancy_from_elasticsearch,export_vacancies_labels_to_elasticsearch,export_vacancies_labels_chunk_to_elasticsearch,remove_vacancy_labels_from_elasticsearch,export_tracking_codes_to_tracker,export_domain_regexes_to_tracker', // query
  'All',          // current
  includeAll=true,
  multi=true,
);
