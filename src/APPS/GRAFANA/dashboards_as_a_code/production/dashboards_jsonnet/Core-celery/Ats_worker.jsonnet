...
local varQueue = grafana.template.custom(
  'queue',  // name
  'ats_download_event_types,single_ats_download_event_types,events_synchronization,single_customer_events_synchronization,single_events_synchronization,single_events_synchronization_proindustry,single_events_synchronization_campaignmonitor,single_events_synchronization_pontoon,single_events_synchronization_haysnl,single_events_synchronization_hireserve,single_events_synchronization_icims,single_events_synchronization_carerix,single_events_synchronization_gini,single_events_synchronization_peoplexs,single_events_synchronization_recruitee,single_events_synchronization_csv_input,single_events_synchronization_greenhouse,single_events_synchronization_salesforce,single_events_synchronization_bullhorn,single_events_synchronization_mysolution,handle_event_downloadatseventtypes,remove_old_candidate_vacancy_logs,analyze_ats_synchronization_logs,analyze_single_ats_synchronization_logs,sum_up_ats_synchronizations',  // query
  'All',  // current
  includeAll=true,
  multi=true,
);
