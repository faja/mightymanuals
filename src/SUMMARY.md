...
- [APPS](./APPS/index.md)
    ...
    - [ansible](./APPS/ANSIBLE/index.md)
        ...
        - [role](./APPS/ANSIBLE/07_role.md)
        - [debugger](./APPS/ANSIBLE/09_debugger.md)
        - [collections](./APPS/ANSIBLE/10_collections.md)
        - [production setup](./APPS/ANSIBLE/11_production_setup.md)
        - [ansible-vault](./APPS/ANSIBLE/12_ansible_vault.md)
        - [sops](./APPS/ANSIBLE/13_sops.md)
        - [docker](./APPS/ANSIBLE/14_docker.md)
        - [callback plug-ins](./APPS/ANSIBLE/14_callback_plugins.md)
        - [ansible ssh tweaks](./APPS/ANSIBLE/19_ansible_ssh_tweaks.md)
        - [modules](./APPS/ANSIBLE/20_modules.md)
        - [syntax: loop](./APPS/ANSIBLE/50_syntax_loop.md)
        - [syntax: if](./APPS/ANSIBLE/51_syntax_if.md)
        - [syntax: templating trix](./APPS/ANSIBLE/52_templating_trix.md)
        - [syntax: filters](./APPS/ANSIBLE/53_syntax_filters.md)
        - [syntax: lookups](./APPS/ANSIBLE/54_syntax_lookups.md)
        - [syntax: includes and imports](./APPS/ANSIBLE/55_syntax_include_import.md)
    ...
    - [k8s](./APPS/K8S/index.md)
        - [yamls](./APPS/K8S/yamls/index.md)
            ...
            - [Statefulset](./APPS/K8S/yamls/statefulset.md)
    - [kind](./APPS/KIND/index.md)
    - [libvirt](./APPS/LIBVIRT/index.md)
    - [loki](./APPS/LOKI/index.md)
    - [mdbook](./APPS/MDBOOK/index.md)
    - [nftables](./APPS/NFTABLES/index.md)
        - [usage](./APPS/NFTABLES/usage.md)
        - [config examples](./APPS/NFTABLES/config_examples.md)
        - [nftables and k8s](./APPS/NFTABLES/k8s.md)
    - [nginx](./APPS/NGINX/index.md)
        - [play](./APPS/NGINX/play.md)
        - [ssl, certs, etc...](./APPS/NGINX/ssl.md)
    ...
    - [terraform](./APPS/TERRAFORM/index.md)
        ...
        - [providers](./APPS/TERRAFORM/providers/index.md)
            - [aws](./APPS/TERRAFORM/providers/aws/index.md)
                - [r53 weighted records](./APPS/TERRAFORM/providers/aws/working_examples/r53_weighted_records/index.md)
                - [s3 bucket, versioning, lifecycle, access](./APPS/TERRAFORM/providers/aws/working_examples/s3_all_the_things/index.md)
...
- [COMMANDS](./COMMANDS/index.md)
    ...
    - [solisten](./COMMANDS/SOLISTEN/index.md)
    ...
    - [tcpstates](./COMMANDS/TCPSTATES/index.md)
...
- [LINUX INTERNALS](./LINUX_INTERNALS/index.md)
    ...
    - [CGROUPS](./LINUX_INTERNALS/CGROUPS/index.md)
    ...
    - [NETWORK](./LINUX_INTERNALS/NETWORK/index.md)
        ...
        - [metrics in practice](./LINUX_INTERNALS/NETWORK/metrics.md)
...
- [PROGRAMMING](./PROGRAMMING/index.md)
    ...
    - [BPFTRACE](./PROGRAMMING/BPFTRACE/index.md)
        - [network](./PROGRAMMING/BPFTRACE/network.md)
    - [GO](./PROGRAMMING/GO/index.md)
        - [TYPES](./PROGRAMMING/GO/TYPES/index.md)
            - [empty struct](./PROGRAMMING/GO/TYPES/empty_struct.md)
            - [struct](./PROGRAMMING/GO/TYPES/struct.md)
