...
```sh
apt update                                      # refresh cache

apt install -V ${package_name}                  #
apt install -y -V ${package_name}               # don't ask for confirmation
apt install -s -V ${package_name}               # dry run
apt install ${package_name}=${package_version}  # install specify version
