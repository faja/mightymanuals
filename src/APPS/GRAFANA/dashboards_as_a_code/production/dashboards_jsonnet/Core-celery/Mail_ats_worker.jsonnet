...
local varQueue = grafana.template.custom(
  'queue',        // name
  'mail_single_customer_events_synchronization,cache_results,mail_single_events_synchronization,mail_single_events_synchronization_mailchimp,single_events_synchronization_mailchimp', // query
  'All',          // current
  includeAll=true,
  multi=true,
);
